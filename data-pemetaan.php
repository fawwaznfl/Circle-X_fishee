                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="text-muted text-uppercase mt-0"><a href="dashboard-vendor.php">Dasbor</a>/ Data Pemetaan </h4>
								...
								while($row = $result->fetch_assoc()) {
									...
									echo "<tr>
											...
											<td>
                                                ...
                                                <a href=\"javascript:dialogHapus('hapus_data_pemetaan.php?id=".$row["id"]."','".$row["pemilik"]."')\" class=\"btn_1 gray\">Hapus</a>
                                            </td>
