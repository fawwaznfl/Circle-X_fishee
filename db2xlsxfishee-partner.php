...
$sheet->setTitle('Partner'); // Set a title for the second sheet
...
$sql = "SELECT tb_pemetaan.pemilik as Pemilik, tb_pemetaan.kategori_partner as Kategori_Partner, tb_pemetaan.deskripsi as Deskripsi, tb_pemetaan.no_telpon as No_Telepon, tb_pemetaan.nama_toko, tb_pemetaan.jam_operasional,tb_pemetaan.lokasi as Lokasi, tb_pemetaan.surat_pernyataan, tb_pemetaan.posisi_lokasi, tb_pemetaan.foto_thumbnail  
        FROM tb_pemetaan";
...
*/
    ...
    $writer->save('data-partner/fishee-partner.xlsx');
