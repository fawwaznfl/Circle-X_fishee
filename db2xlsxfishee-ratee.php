...
$sheet->setTitle('Rate'); // Set a title for the second sheet
...
$sql = "SELECT tb_pemetaan.pemilik, ratee.name as Username, ratee.rate as Rating, ratee.ulasann as Ulasan, ratee.balasan as Balasan
        FROM ratee 
...
if (mysqli_num_rows($data) > 0) {
    ...
    $writer->save('data-rating/fishee-ratee.xlsx');

    // Redirect to membatasi_pengunjung.php
    header("Location: membatasi-pengunjung.php");
    exit();

    echo "Data berhasil diekspor ke data-ratee.xlsx";
} else {
