                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-hover tablesorter" id="myTableUtama">
						...
						<?php
                                ...
                                $sql = "SELECT tb_produk.*, tb_pemetaan.nama_toko FROM tb_produk INNER JOIN tb_pemetaan  ON tb_produk.id_toko = tb_pemetaan.id WHERE username = '$nama_lengkap'";
								...
								while($row = $result->fetch_assoc()) {
									...
									echo "<tr>
											...
											<td>". $array_kategori[$row["kategori"]]."</td>
											<td>". $row["deskripsi"]." </td>
											<td>". $row["harga"]."</td>
											<td><img src=". 'images/'  . $row["foto_produk"]."  width='100' height='100' ></td>                                            
											<td>
                                                <a href=\"update_datprod.php?id=".$row["id"]."\" class=\"btn_1\">Ubah</a><br>
                                                <a href=\"javascript:dialogHapus('hapus_datprod.php?id=".$row["id"]."','".$row["nama_Produk"]."')\" class=\"btn_1 gray\">Hapus</a>
                                            </td>
                        ...
                        <!--
                            <tr>
                                <td>1</td>
                                <td>Ikan Gurame Segar</td>
                                <td>Ps Baru</td>
                                <td>Ikan Segar</td>
                                <td>Lorem Ipsum&#8230;</td>
                                <td>Rp25,000</td>
                                <td>
                                    <a href="assets/images/gurame-segar.jpg" target="_blank"><img src="assets/images/gurame-segar.jpg" alt="Foto Produk" class="img-fluid" width="50%" height="50%"></a>
                                 </td>
                                 <td><a href="list_ulasan.php">Lihat Ulasan</a></td>
                                 <td>
                                    <a href="update_datprod.php" class="btn_1">Edit</a><br>
                                    <a href="#" class="btn_1 gray" id="btn-hapus">Hapus</a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Ikan Tuna Segar</td>
                                <td>Ps Baru</td>
                                <td>Ikan Segar</td>
                                <td>Lorem Ipsum&#8230;</td>
                                <td>Rp40,000</td>
                                <td>
                                    <a href="assets/images/tuna-segar.jpg" target="_blank"><img src="https://sig-kel-1.candrawjy.my.id/uploads/produk/gudeg_7.jpg" alt="Foto Produk" class="img-fluid" width="50%" height="50%"></a>
                                </td>
                                <td><a href="#">Lihat Ulasan</a></td>
                                <td>
                                    <a href="#" class="btn_1">Edit</a><br>
                                    <a href="#" class="btn_1 gray" id="btn-hapus">Hapus</a>
                                </td>
                            </tr>
                            -->
