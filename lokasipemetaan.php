...
<body>
    ...
    <header class="header header-layout1">
      ...
      <section class="page-title page-title-layout1 bg-overlay bg-overlay-2 bg-parallax text-center">
        <div class="bg-img"><img src="assets_guests/images/banners/world_maps.jpg" alt="background"></div>
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
              <h1 class="pagetitle__heading mb-0">Lokasi Partner UMKM</h1>
              <p class="pagetitle__desc mb-0">Cari lokasi partner UMKM dengan mudah, cepat dan akurat di sekitar anda, Ini merupakan langkah penting dalam mendukung pertumbuhan UMKM lokal dan memfasilitasi kolaborasi antara konsumen dan pemilik UMKM.  </p>
            </div>
            </div><!-- /.col-xl-6 -->
          </div><!-- /.row -->
        </div><!-- /.container -->
    ...
    <script>
        ...
        // PHP code to fetch coordinates and generate markers
        <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                //$lat = $row["latitude"];
                //$lng = $row["longitude"];
                $posisi_lokasi = explode(',',$row["posisi_lokasi"]);
                ...
                echo "
                  ...
                  marker.bindPopup('<img src=\"$foto_thumbnail\" width=\"200\" height=\"175\"> <br/><br/> <h5>$nama_toko</h5> <h6 style=\"margin-top:-15px\">$lokasi <br /> $no_telpon </h6>').openPopup();
