...
<body>
  <div class="wrapper">
    ...
    <section class="page-title page-title-layout1 bg-overlay bg-overlay-2 bg-parallax text-center">
      <div class="bg-img"><img src="assets_guests/images/banners/olahanikan.jpg" alt="background"></div>
      <div class="container">
        <div class="row">
          <div class="col-12">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-8 col-lg-9">
            <div class="sorting-options d-flex flex-wrap justify-content-between align-items-center mb-30">
              <strong>Berbagai Produk Olahan Ikan</strong>
            </div>
            <div class="row">
              <!-- Product item #1 -->
              ...
              $sql = "SELECT * FROM tb_produk INNER JOIN tb_pemetaan ON tb_produk.id_toko = tb_pemetaan.id WHERE kategori = 'O'";
              
              if (isset($_GET['search'])) {
                  $search = $_GET['search'];
                  $sql = " SELECT * FROM tb_produk INNER JOIN tb_pemetaan ON tb_produk.id_toko = tb_pemetaan.id WHERE kategori = 'O' AND nama_Produk LIKE '%$search%'";
              }
            ...
            <aside class="sidebar-layout2">
              ...
              <div class="widget widget-search">
                ...
                <div class="widget__content">
                  <form action="olahanikan.php" method="GET" class="widget__form-search">
