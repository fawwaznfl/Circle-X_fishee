            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <div class="page-links">
                            <a href="ubahpassword.php" class="active">Password Baru</a>
                        </div>
                        <form>
                            <input class="form-control" type="text" name="username" placeholder="Masukkan Password Baru" required>
                            <input class="form-control" type="text" name="username" placeholder="Masukkan Ulang Password Baru" required>
                            <div class="form-button">
                                <button id="submit" type="submit" class="ibtn" style="background-color:#445867;"><a href="login.php">Ubah Password</a></button>
                            </div>
                    </div>
                </div>
            </div>
