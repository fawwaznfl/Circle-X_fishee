...
<head>
  ...
  <link href="assets_guests_guests/images/favicon/logo-profil.png" rel="icon">
          ...
          <div class="col-sm-12 col-md-8 col-lg-9">
            <div class="sorting-options d-flex flex-wrap justify-content-between align-items-center mb-30">
              ...
              <select id="sortumkm" onchange="sortHandler(this.value)">
                ...
                <option value="umkm-tertinggi">Rating Tertinggi</option>
                <option selected value="umkm-terendah">Rating Terendah</option>
              </select>
            </div>
            <div class="row">
