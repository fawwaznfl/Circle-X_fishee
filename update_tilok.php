            ...
            <div class="page-content">
                <div class="container-fluid">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="list_tilok.php">List Titik Lokasi</a></li>
                    ...
                    <div class="box_general padding_bottom">
                        ...
                        <form action="h05_aksiSimpanUpdateTilok.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6">
    ...
    map.on('click', function (e) {
        ...
        marker.on('dragend', function () {
            ...
            document.getElementById('lat_long').value = newLatLng.lat + ', ' + newLatLng.lng;
                                ...
                                <div class="form-group">
                                        <label for="surat_pernyataan">Upload surat pernyataan: <small class="text-danger">upload dalam bentuk pdf</small> <br><a href="surat_pernyataan/surat-pernyataan.docx">Unduh Surat disini</a> </label> <br>
                                        <input type="file" name="surat_pernyataan" id="surat_pernyataan" accept=".pdf" value=<?php echo $row["surat_pernyataan"]; ?>>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Foto Thumbnail 
                                            ...
                                            <input type="file" class="form-control" id="foto_thumbnail" name="foto_thumbnail" accept=".jpeg, .png, .jpg" value=<?php echo $row["foto_thumbnail"]; ?>>>
                                        <small class="text-danger"></small>
                                    </div>
